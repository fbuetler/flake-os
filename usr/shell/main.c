...
int main(int argc, char *argv[])
{
    ...
    write_str(" _______ ___     _______ ___   _ _______ __   __    _______ _______ \n");
    write_str("|       |   |   |       |   | | |       |  | |  |  |       |       |\n");
    write_str("|    ___|   |   |   _   |   |_| |    ___|  |_|  |  |   _   |  _____|\n");
    write_str("|   |___|   |   |  |_|  |      _|   |___|       |  |  | |  | |_____ \n");
    write_str("|    ___|   |___|       |     |_|    ___|_     _|  |  |_|  |_____  |\n");
    write_str("|   |   |       |   _   |    _  |   |___  |   |    |       |_____| |\n");
    write_str("|___|   |_______|__| |__|___| |_|_______| |___|    |_______|_______|\n");
    write_str("\n\n");
