...
#define MAX_MEM_REGIONS                                                                  \
    ((BOOTINFO_SIZE - sizeof(struct bootinfo)) / sizeof(struct mem_region))
...
#define TASKCN_SLOT_ARGSPAGE                                                             \
    10  ///< Cap for the page containing a list of command line arguments
